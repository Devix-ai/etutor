...
const SingupQuestions = () => {
  ...
  help with?' />
          <div className="relative">
            <div className='flex justify-between items-center cursor-pointer w-full  px-5 py-2 bg-purple rounded-3xl text-darkBlue text-2xl mb:text-sm'  onClick={toggleDropdown}>
            <button
           
            className="  bg-purple focus:outline-none"
          >
select subject(s)          </button>
