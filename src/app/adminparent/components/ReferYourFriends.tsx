    ...
    <div className="flex flex-col gap-9">
      ...
      >
        ...
        <div className="px-10 custom-2xl:px-20 mt-5 custom-2xl:mt-10 mb-10 custom-2xl:mb-20">
          <p className= {`text-sm sm:text-lg custom-2xl:text-2xl font-medium mb-2   ${subGetButtonStyles(
              subActiveTab === "student"
            )}`}>
          ...
          <div className="mt-5 custom-2xl:mt-10 py-2 sm:py-3 pl-5 sm:pl-10 custom-2xl:pl-20 pr-2 custom-2xl:pr-4 max-w-[58rem] flex bg-[#685AAD] rounded-3xl overflow-hidden">
            <input
              type="text"
              value="https://www.freepik.com/premium-photo/empty-chairs-tables-row_118044802.htm"
              readOnly
              className="flex-grow bg-[#685AAD] py-2 outline-none"
            />
            <button className="bg-[#8653FF] text-white px-4 sm:px-8 custom-2xl:px-16 rounded-xl py-2 sm:py-3 custom-2xl:py-5 text-sm sm:text-lg font-medium">Copy</button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#EDE8FA] rounded-3xl ">
        ...
        <div className=" py-3 sm:py-6 custom-2xl:py-12 px-8 custom-2xl:px-16 grid grid-cols-3 gap-4 bg-[#A296CC] rounded-3xl">
          <div>
            <h4 className="text-[#685AAD]  text-sm sm:text-lg custom-2xl:text-2xl font-bold mb-1">Share your link</h4>
          ...
          <div>
            <h4 className="text-[#685AAD] text-sm sm:text-lg custom-2xl:text-2xl font-bold mb-1">Your friends join</h4>
            <p className="text-white text-xs sm:text-lg custom-2xl:text-xl  max-w-[16rem]">
