  ...
  return (
    <div className="w-full  h-full pt-4 bg-[#EDE8FA] rounded-3xl  relative mt-12">
      <div className="flex justify-between items-start mb-4 absolute top-0 left-0 w-full">
        ...
        <div className="bg-white h-10 sm:h-[89px] w-[38%] rounded-bl-3xl     transition-all  hidden sm:flex items-start  justify-center px-4 custom-lg:px-8 pb-4 ">
          {activeTab === "trial" ? (
            ""):(
              
          <div className="text-[#685AAD] font-bold text-xs px-2 transition-all  w-[80%]   md:text-sm custom-2xl:text-xl h-full  rounded-md sm:rounded-xl mb-1 uppercase  bg-[#EDE8FA]  flex items-center justify-center ">
          Sessions&nbsp;left:2
          </div>
              )}
        </div>
      ...
      <div className="mt-[132px] ml-3">
        {activeTab === "trial" ? (
          <div className="bg-[#473171] ml-2 sm:ml-10  py-3 px-3 text-sm rounded-xl w-fit flex ">
            <button
              onClick={() => setActiveSubTab("upcoming")}
              className={`flex-1 py-3 sm:py-6 px-14  text-center rounded-xl transition-all duration-300 ${
            ...
            <button
              ...
              className={`flex-1 py-3 sm:py-6 px-[40px] text-center rounded-xl transition-all duration-300 ${
          ...
          <div className="bg-[#473171] ml-2 sm:ml-10 py-3 px-3 text-sm rounded-xl w-fit flex ">
            <button
              onClick={() => setActiveSubTab("upcoming")}
              className={`flex-1 py-3 sm:py-6 px-12 text-center rounded-xl transition-all duration-300 ${
                activeSubTab === "upcoming"
                  ? "bg-[#8653FF] text-white"
                  : "text-[#d8b4fe]"
              }`}
      ...
      <div className="bg-[#a296cc] p-2 custom-xl:p-4 rounded-3xl mt-10  h-full overflow-auto">
        {/* --------------individual session-----------------   */}
