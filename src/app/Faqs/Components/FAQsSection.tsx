...
const FAQsSection:React.FC = () => {
  ...
  return (
    <div>
    <div id="faq-etutor" className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl mb:p-5 mb:rounded-xl mb:w-full '>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>Become an eTutor </h2>
      <FAQs faqData={eTutorFaqs} display='hidden' />
    </div>
    <div id='faq-for-etutors' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>For eTutors</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    <div id='faq-packages' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>Packages</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    <div id='faq-technical-questions' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>Technical questions</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    <div id='faq-general-questions' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>General questions</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    <div id='faq-booking' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>Booking</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    <div id='faq-security' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>Security</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    <div id='faq-etutor4me' className='py-16 pl-4 bg-cardbg w-[85%] m-auto rounded-3xl my-56 mb:p-5 mb:rounded-xl mb:w-full mb:my-16'>
        <h2 className='text-darkBlue text-4xl font-extrabold pl-10 pb-8 mb:text-xl'>eTutor4Me</h2>
      <FAQs faqData={PackageFaqs} display='hidden' />
    </div>
    </div>
