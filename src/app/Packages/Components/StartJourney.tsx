...
const StartJourney = () => {
  return (
    ...
    <h2 className='text-5xl 2xl:text-[65px] font-extrabold text-blue mb:text-2xl mb:px-3 xl:text-3xl lg:text-3xl'>Getting started is simple with eTutor4Me</h2>
    
 
    <div className='flex justify-around items-stretch space-x-4 py-20 mb:flex-col mb:gap-10 mb:py-8 mb:justify-center mb:items-center tb:flex-wrap'>
      <div className='relative w-1/4 mb:w-4/5  lg:w-[28%]'>
        ...
        <div className='relative bg-white h-full rounded-xl border-darkBlue border px-8 py-10  flex flex-col justify-between z-10'>
          <div className='flex flex-col items-start justify-start flex-grow'>
            ...
            <p className='text-xl  2xl:text-[32px] text-[#473171] leading-normal mt-2 mb:text-sm mb:leading-normal'>
