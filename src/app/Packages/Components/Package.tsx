...
const Package = () => {
  ...
  <div className='relative w-[30%] mb:w-11/12 h-full'>
    ...
    <div className='relative bg-white rounded-3xl border-[#646493] border-2'>
      ...
      <div className='p-6 mb:p-4 text-center'>
        <h3 className='text-customBlue text-2xl 2xl:text-4xl flex items-end justify-center gap-2 font-extrabold mb:text-xl'>
  <span className='text-6xl 2xl:text-[80px] self-end'>8</span> 
  <span className='self-end'>Sessions / month</span>
</h3>
  ...
  <div className='relative w-[30%] mt-10 mb:w-11/12 mb:mt-0 h-full'>
    <div className='absolute inset-0 transform translate-x-4 h-auto translate-y-4 bg-[#CFCCDD] rounded-3xl shadow-lg mb:-translate-x-4' ></div>
    <div className='relative bg-white rounded-3xl border-darkBlue border-2'>
      ...
      <div className='p-8 mb:p-4'>
        ...
        <p className='text-darkBlue 2xl:text-[28px] 2xl:py-6 xl:my-10 text-xl lg:text-lg my-4 text-center font-medium mb:text-sm'>
        ...
        <p className='text-darkBlue text-base 2xl:text-xl lg:text-xs my-8 text-center font-bold mb:text-xs'>
          <span className='text-customBlue underline'>Contact us</span> Contact us for a personalized one with a discount
        </p>
      </div>
    </div>
  </div>
