...
export async function POST(req: Request) {
    try {
        ...
        if (!email || !password || !contactInformation || !contactInformation.email || !education || !experience || !experience.is18OrAbove || !experience.hasTeachingExperience || !experience.generalAvailability || experience.generalAvailability.length === 0) {
