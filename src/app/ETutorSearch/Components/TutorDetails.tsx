    ...
    <>
{
  ...
  <div className=' flex w-100 gap-12 border-b justify-between border-[#9C8BBD] mx-12 lg:mx-6 py-16 mb:py-8 mb:flex-col mb:mx-0 mb:gap-4 tb:flex-col'>
...
<div className='flex items-center w-[55%] justify-between gap-24  mb:gap-4 mb:w-full mb:flex-col mb:justify-start mb:items-start tb:flex-row'>
