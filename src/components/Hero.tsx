  ...
  return (
    <div className='w-full flex items-center mb:flex-col mb:gap-6 mb:py-4 mb:justify-center' >
      <div className='mb:w-full mb:text-center  w-1/2 '>
        <h2 className=' text-5xl mb:text-2xl font-roboto font-extrabold lg:text-3xl xl:text-4xl '>
        ...
        <h3 className='text-darkBlue font-roboto font-bold text-3xl  w-10/12 mt-10 leading-9  lg:text-xl lg:leading-normal xl:text-lg mb:text-sm mb:w-full mb:leading-normal mb:mt-5'>Our eTutors are chosen for their exceptional knowledge and their ability to relate to fellow students. Experience the difference with us and dachieve your academic goals!</h3>
        <div className='pt-32 lg:pt-12 mb:pt-10'>

        <Link href='/SignupAs' > <Button className='px-12 py-6 lg:px-10 lg:text-xl ' btnName='BOOK A FREE SESSION' /></Link> 
        </div>
      </div>
