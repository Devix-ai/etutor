  ...
  return (
    <div className='w-full px-4 flex items-center mb:flex-col mb:gap-6 mb:py-6 mb:px-0 mb:justify-center' >
      <div className='mb:w-full mb:text-center  w-1/2 '>
        <h2 className=' text-[64px] leading-tight pt-10 mb:text-3xl font-extrabold lg:text-[40px] xl:text-6xl '>
        ...
        <h3 className='text-darkBlue  font-medium text-3xl  w-10/12 mt-12 leading-9  lg:text-lg lg:mt-8 lg:leading-normal xl:text-2xl mb:text-sm mb:w-full mb:leading-normal mb:mt-5'>
